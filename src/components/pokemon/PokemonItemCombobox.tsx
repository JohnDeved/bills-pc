...
export function PokemonItemCombobox({
  ...
  const selected = valueIdName
    ? ITEMS.find((i) => i.id_name === valueIdName)
    : undefined;
            ...
            <CommandGroup heading="Held Item">
              ...
              >
                <div className="flex w-full items-center">
                  ...
                  />
                  <span className="mr-2 font-sans font-normal leading-5">
                    None
                  </span>
                </div>
              </CommandItem>
                ...
                return (
                  ...
                  >
                    <div className="flex w-full items-center gap-2">
                      ...
                      />
                      <span className="font-sans font-normal leading-5">
                        {item.name}
                      </span>
                    </div>
                  </CommandItem>
