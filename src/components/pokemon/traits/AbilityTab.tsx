...
export const AbilityTab: React.FC = () => {
  ...
  const baseAbility = !pokemon?.details
    ? null
    : pokemon.details.abilities.find(
        (a) => a.slot === pokemon.data.abilityNumber + 1,
      );
  const isMega = Boolean(
    megaPreviewEnabled && megaAbilities && megaAbilities.length,
  );
    ...
    <div className="flex-1 flex flex-col">
      <div className="px-4 pt-3 flex-shrink-0">
        <div className="text-foreground mb-2">
          <Skeleton.Text className="font-pixel text-lg">
